...
# # as a function of input dimension (rest of architecture fixed)
#
#
# # ==================================
...
layer_widths = [int(d) for d in np.linspace(10, 100, 12)]
num_samples = 100

# Two examples (low dim, high dim)
for input_dim in [5]: #[2, 6, 12, 20]:
    ess_percentages_per_width = []
    num_facets_per_width = []
    ...
    for width in layer_widths:
        ...
        num_facets_per_width.append(num_essential)
    # =========================
    # Plot Percentages vs Layer width
    # =========================

    plt.plot(layer_widths, num_facets_per_width, label='In Dim: '+str(input_dim))
    # plt.title('Avg. Percent. Essential vs. Layer width ')
    # plt.ylabel('% Essential')
    plt.title('Num Facets vs. Layer width ')
    plt.ylabel('Num Facets')
...
# # ==================================
#
# input_dims = [int(d) for d in np.linspace(4, 20, 4)]
# num_samples = 1
#
# # Widths examples
...
#         # Save Data per dimension
#             ess_percentages_per_dim.append(np.mean(ess_percentages))
#             num_facets_per_dim.append(num_essential)
#     # =========================
#     # Plot Percentages vs Layer width
#     # =========================
#
#     plt.plot(input_dims, ess_percentages_per_dim, label='Width: '+str(width))
#     plt.title('Avg. Percent. Essential vs. Input Dimension ')
#     plt.ylabel('% Essential')
#     # plt.title('Num Facets vs. Input Dimension ')
#     # plt.ylabel('Num Facets')
#     plt.xlabel('Input dimensions (2 layer RELU)')
#
#
#
# # Show Plot
